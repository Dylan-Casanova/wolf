...
class DeviceClaimTest extends TestCase
{
    ...
    #[Test]
    public function user_can_claim_unclaimed_device(): void
    {
    ...
    #[Test]
    public function user_cannot_claim_device_owned_by_another(): void
    {
        $user = User::factory()->create();
    ...
    #[Test]
    public function user_cannot_claim_device_they_already_own(): void
    {
        $user = User::factory()->create();
    ...
    #[Test]
    public function claim_returns_error_for_unknown_device(): void
    {
        $user = User::factory()->create();
    ...
    #[Test]
    public function claim_requires_device_id(): void
    {
        $user = User::factory()->create();
    ...
    #[Test]
    public function guest_cannot_claim_device(): void
    {
